...
require_once 'config9.php';

// Correct SQL query syntax
$query = "SELECT name, email, password_hash  FROM `user`";
        ...
        <div class="main">
            ...
            <div class="report-container">
                <div class="report-header">
                    <h1 class="recent-resident">Residents Accounts</h1>
                </div>
                ...
                <div class="items">
                 <?php while ($items = mysqli_fetch_assoc($result)) { ?>
                    <div class="item1">
                        <h3 class="t-op-nextlvl"><?php echo htmlspecialchars($items['name']); ?></h3>
                        <h3 class="t-op-nextlvl"><?php echo htmlspecialchars($items['email']); ?></h3>
                        <h3 class="t-op-nextlvl "><?php echo htmlspecialchars($items['password_hash']); ?></h3>
