...
$query = "SELECT firstname, contactnumber, purpose FROM bclerance";
            ...
            <nav class="nav">
                <div class="nav-upper-options">
                    ...
                    <div class="option3 nav-option">
                        ...
                        <h3> Job Seekers</h3>
                        <div class="dropdown-content">
                            <a href="djobseeker.php"> First Time Job Seeker</a>
                            </div>
                        </div>
            ...
            <div class="report-container">
                ...
                <div class="items">
                 <?php while ($items = mysqli_fetch_assoc($result)) { ?>
                    <div class="item1">
                        <h3 class="t-op-nextlvl"><?php echo htmlspecialchars($items['firstname']); ?></h3>
                        <h3 class="t-op-nextlvl"><?php echo htmlspecialchars($items['contactnumber']); ?></h3>
                        <h3 class="t-op-nextlvl "><?php echo htmlspecialchars($items['purpose']); ?></h3>
