...
$query = "SELECT first_name,contact_number,reason  FROM permit";
        ...
        <div class="main">
            ...
            <div class="report-container">
                <div class="report-header">
                    <h1 class="recent-resident">Recent Resident</h1>
                </div>
                ...
                <div class="items">
                 <?php while ($items = mysqli_fetch_assoc($result)) { ?>
                    <div class="item1">
                        ...
                        <h3 class="t-op-nextlvl"><?php echo htmlspecialchars($items['contact_number']); ?></h3>
                        <h3 class="t-op-nextlvl "><?php echo htmlspecialchars($items['reason']); ?></h3>
