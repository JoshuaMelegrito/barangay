...
$query = "SELECT first_name, contact, residency_type FROM barangay_id_application";
            ...
            <div class="report-container">
                ...
                <div class="report-body">
                    <div class="report-topic-heading">
                        ...
                        <h3 class="t-op">RESIDENT TYPE</h3>
                ...
                <div class="items">
                 <?php while ($items = mysqli_fetch_assoc($result)) { ?>
                    <div class="item1">
                        ...
                        <h3 class="t-op-nextlvl "><?php echo htmlspecialchars($items['residency_type']); ?></h3>
