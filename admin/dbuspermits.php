...
$query = "SELECT first_name, contact, businessname  FROM busspermit";
            ...
            <div class="report-container">
                ...
                <div class="report-body">
                    <div class="report-topic-heading">
                        ...
                        <h3 class="t-op">BUSINESS NAME</h3>
                ...
                <div class="items">
                 <?php while ($items = mysqli_fetch_assoc($result)) { ?>
                    <div class="item1">
                        ...
                        <h3 class="t-op-nextlvl "><?php echo htmlspecialchars($items['businessname']); ?></h3>
